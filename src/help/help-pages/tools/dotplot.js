...
const Dotplot = () => (
  <div>
    <div>
      ...
      <ol className="HelpPages-list">
        <li>
          SVGs: This folder contains the dot plot and heat map images, as well
        ...
        <li>
          CytoscapeFiles: This folder contains plain text files for importing
        ...
        <li>
          OtherFiles: This folder contains bait-bait and prey-prey dendrograms
