...
const validTypes = ['dotplot', 'heatmap'];
...
// type is "dotplot" or "heatmap", this includes checking for "column"
...
const ValidateJson = (jsonString) => {
  ...
  // The analysis type should be specified.
  if (
    !json.params.analysisType ||
    !validTypes.includes(json.params.analysisType)
  ) {
    return {
      err: true,
      message: 'The analysis type must be specified in the params object and be of a supported type',
    };
  }
